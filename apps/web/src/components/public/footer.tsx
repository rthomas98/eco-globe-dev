          ...
          <div className="flex gap-[60px]">
            ...
            <div className="flex w-[240px] shrink-0 flex-col gap-12">
              ...
              <div className="flex gap-6">
                <a href="#" aria-label="LinkedIn" className="flex size-8 items-center justify-center rounded-full bg-neutral-700 transition-colors hover:bg-neutral-600">
                ...
                <a href="#" aria-label="Instagram" className="flex size-8 items-center justify-center rounded-full bg-neutral-700 transition-colors hover:bg-neutral-600">
                  <svg className="size-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="#" aria-label="Facebook" className="flex size-8 items-center justify-center rounded-full bg-neutral-700 transition-colors hover:bg-neutral-600">
                  <svg className="size-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="flex flex-1 flex-col gap-[60px]">
              ...
              <div className="grid grid-cols-3 gap-x-[60px]">
                ...
                <FooterSection
                  title="Company"
                  links={["About", "Contact Us", "Careers", "FAQs", "Help Center", "ewsletter"]}
                />
                <FooterSection
