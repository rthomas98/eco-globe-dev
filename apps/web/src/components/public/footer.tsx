          ...
          <div className="flex flex-col md:flex-row gap-8 lg:gap-[60px]">
            ...
            <div className="flex w-full md:w-[240px] shrink-0 flex-col gap-12">
              ...
              <div className="flex gap-6">
                <a href="https://www.linkedin.com/company/ecoglobeworld" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex size-8 items-center justify-center rounded-full bg-neutral-700 transition-colors hover:bg-neutral-600">
                ...
                <a href="https://www.instagram.com/ecoglobeworld/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex size-8 items-center justify-center rounded-full bg-neutral-700 transition-colors hover:bg-neutral-600">
                  <svg className="size-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://www.facebook.com/ecoglobeworld/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex size-8 items-center justify-center rounded-full bg-neutral-700 transition-colors hover:bg-neutral-600">
                  <svg className="size-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
