...
const navIcons: NavIcon[] = [
  ...
  { href: "/buyer/delivery-tracking", icon: Route, label: "Delivery Tracking" },
  { href: "/buyer/partners", icon: Network, label: "Partners" },
  { href: "/buyer/asset-verification", icon: ShieldCheck, label: "Asset Verification" },
  { href: "/buyer/map-intelligence", icon: MapPin, label: "Map Intelligence" },
  { href: "/buyer/analytics", icon: BarChart3, label: "Analytics" },
  { href: "/buyer/recommendations", icon: Lightbulb, label: "Recommendations" },
  { href: "/buyer/blockchain-traceability", icon: Blocks, label: "Blockchain" },
  { href: "/buyer/smart-contracts", icon: Workflow, label: "Smart Contracts" },
  { href: "/buyer/language", icon: Languages, label: "Language" },
  { href: "/buyer/national-expansion", icon: Rocket, label: "National Expansion" },
  { href: "/buyer/mobile-access", icon: MonitorSmartphone, label: "Mobile Access" },
