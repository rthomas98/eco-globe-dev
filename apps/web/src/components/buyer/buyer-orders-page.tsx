...
const ORDER_PRODUCT_IMAGES: Record<string, string> = {
  ...
  "FCC Slurry Oil": "/products/generated/dark-viscous-liquids.png",
  Tar: "/products/generated/tar.png",
  Biochar: "/products/generated/biochar.png",
  Hydrochar: "/products/generated/hydrochar.png",
  "Used Cooking Oil": "/products/generated/used-cooking-oil.png",
...
export const orders: Order[] = [
  {
    ...
    productImage: ORDER_PRODUCT_IMAGES["Pyrolysis Pitch"],
    productPrice: "$50.00",
  },
  {
    id: "2",
    ...
    category: "Refinery",
    seller: "GulfStar Chemicals",
    product: "Epoxy Off-Spec",
    productImage: ORDER_PRODUCT_IMAGES["Epoxy Off-Spec"],
    productPrice: "$50.00",
  },
  {
    id: "2b",
    ...
    category: "Refinery",
    seller: "GulfStar Chemicals",
    product: "FCC Slurry Oil",
    productImage: ORDER_PRODUCT_IMAGES["FCC Slurry Oil"],
    productPrice: "$50.00",
  },
  {
    id: "2c",
    ...
    seller: "GulfStar Chemicals",
    product: "Tar",
    productImage: ORDER_PRODUCT_IMAGES["Tar"],
    productPrice: "$50.00",
  },
  {
    id: "3",
    orderId: "OD20413",
    orderPlaced: "May 12, 2026",
    shipping: "Pickup",
    qty: "20 tons",
    total: "$3,000.00",
    status: "Processing",
    ...
    productImage: ORDER_PRODUCT_IMAGES["Black Gypsum"],
    productPrice: "$50.00",
  },
  {
    id: "4",
    orderId: "TS98765",
    orderPlaced: "May 10, 2026",
    shipping: "Delivery",
    qty: "20 tons",
    total: "$1,000.00",
    status: "Shipped",
    ...
    seller: "GulfStar Chemicals",
    product: "Biochar",
    productImage: ORDER_PRODUCT_IMAGES["Biochar"],
    productPrice: "$50.00",
  },
  {
    id: "5",
    orderId: "TS98766",
    orderPlaced: "May 08, 2026",
    shipping: "Pickup",
    qty: "20 tons",
    total: "$1,000.00",
    status: "Completed",
    ...
    seller: "GulfStar Chemicals",
    product: "Hydrochar",
    productImage: ORDER_PRODUCT_IMAGES["Hydrochar"],
    productPrice: "$50.00",
  },
  {
    id: "6",
    orderId: "TS98767",
    orderPlaced: "May 06, 2026",
    shipping: "Delivery",
    qty: "20 tons",
    total: "$1,000.00",
    status: "Cancelled",
    ...
    productImage: ORDER_PRODUCT_IMAGES["Used Cooking Oil"],
    productPrice: "$50.00",
  },
  {
    id: "7",
